...
The Home Manager module installs the template but deliberately does not
overwrite an existing `~/.config/matugen/config.toml`. Add this entry to your
existing matugen configuration to generate Kaname's palette with the rest of
the system themes:
